...
namespace Community.PowerToys.Run.Plugin.WebSearchShortcut
{
    ...
    public class WebSearchShortcutStorage : IWebSearchShortcutStorage
    {
        ...
        /// <inheritdoc/>
        public IReadOnlyCollection<Item> GetRecords(string query) =>
            Data
                .Values
        ...
        public void Load()
        {
            ...
            try
            {
                ...
                Data =
                    JsonSerializer.Deserialize<Dictionary<string, Item>>(json, _serializerOptions)
                    ?? [];
        ...
        public string GetPath() =>
            Path.Combine(Settings.StorageDirectoryPath, Settings.StorageFileName);
    }
