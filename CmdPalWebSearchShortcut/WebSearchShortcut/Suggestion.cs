...
{
    string Name { get; }
    Task<Suggestion[]> GetSuggestionsAsync(string query, CancellationToken cancellationToken = default);
}
...
{
    public static string[] ProviderNames => [.. _suggestionsProviders.Keys];
